...
public class IntroTalkManager : MonoBehaviour
{
    ...
    private void IntroDialog()      
    {
        talkData.Add(0, new string[] { "멀지 않은 곳에서 파도 소리가 들려온다.:1:0",
            ...
            "“이봐! 아무도 없어?!”:1:10",
            "큰 소리로 외쳤지만 돌아오는 것은 부서진 배의 파편이 파도를 따라 밀려왔다 다시 떠내려가는 모습 뿐이었다.:1:0",
            "“설마 나만 살아 남은 건가?”:1:0",
            "작은 중얼거림이 파도 소리에 묻혀 흩어졌다.:1:0",
            "“여기가 어딘진 모르겠지만 우선 살아 나갈 방법을 찾아 봐야겠어.”:1:0",
            "방향키나 WASD 를 눌러 이동할 수 있습니다.:1:0"});
