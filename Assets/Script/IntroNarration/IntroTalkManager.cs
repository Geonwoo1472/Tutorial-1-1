...
public class IntroTalkManager : MonoBehaviour
{
    ...
    private void IntroDialog()
    {
        talkData.Add(0, new string[] { "멀지 않은 곳에서 파도 소리가 들려온다.:0",
            "입안 가득 퍼석한 모래알이 씹힌다.:0",
            "기침과 함께 토해냈지만 여전히 혓바닥과 입 천장은 까끌거린다.:0",
            "뻑뻑한 눈을 손으로 비벼 억지로 뜨니 그제야 주변 풍경이 눈에 들어온다.:0",
            "쨍쨍히 내리쬐며 시야를 방해하는 햇살, 모래사장과 사방이 바다로 둘러싸인, 이곳은 사람 한 명 살 것 같지 않은 무인도다.:0",
            "‘분명 마지막엔…’ :0",
            "존은 기억을 떠올렸다.:0",
            "폭풍우와 부서진 배, 그리고 항해를 함께 했던 선원들의 모습이 조각조각 떠오른다.:0",
            "“이봐! 아무도 없어?!”:1",
            "큰 소리로 외쳤지만 돌아오는 것은 부서진 배의 파편이 파도를 따라 밀려왔다 다시 떠내려가는 모습 뿐이었다.:1",
            "“설마 나만 살아 남은 건가?”:1",
            "작은 중얼거림이 파도 소리에 묻혀 흩어졌다.:1",
            "“여기가 어딘진 모르겠지만 우선 살아 나갈 방법을 찾아 봐야겠어.”:1",
            "방향키나 WASD 를 눌러 이동할 수 있습니다.:1"});
    }
