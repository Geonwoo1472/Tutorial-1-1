...
public class IntroDialogManager : MonoBehaviour
{
    ...
    public IntroTalkManager talkManager;             //talkManger.cs
    ...
    public delegate void EndCommunication();
    public EndCommunication endCommunication;
    ...
    void Talk(int ID, bool isNpc)
    {
        ...
        if (isNpc)
        {
            ...
            if(a != 0)
            {
                ...
                {
                    case 10:
                        IntroSoundManager.instance.Lightning(); // 천둥사운드 play
                    break;
