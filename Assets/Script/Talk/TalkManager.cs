...
public class TalkManager : MonoBehaviour
{
    ...
    {
        talkData.Add(100, new string[] { "“이런곳에 표지판이 있다니, 일단 확인해보자.”",
            "Space bar를 누르면 물체와 상호작용 할 수 있습니다." });

        talkData.Add(101, new string[] { "앞을 가로막고 있는 상자를 움직여 길을 지나갈 수 있습니다." ,
            "“상자를 움직여서 길을 뚫고 앞으로 나아가라는 건가?”",
            "“설마 함정은 아니겠지...”",
            "“다른 방법도 없으니 일단 표지판에 쓰여진 대로 해볼까?”",
            "상자를 이동하면 피로도가 감소합니다.",
    ...
    {
        talkData.Add(200, new string[] { "“이제 슬슬 주변에 나무들이 많아지기 시작하는군.”",
            "“해변은 겨우 탈출한 건가.”",
            "“그나저나 혼자서 계속 돌아다녔더니 진이 다 빠져서 이거 원..”",
            "“눈 좀 붙이고 싶은데 어디 쉬어갈 곳 없나?”",
            "“어? 저건 천막이잖아?”",
            "“낡긴 했지만 몸을 못 누일 정도는 아니야.”",
            "“이 곳에서 잠깐 쉬어가는 게 좋겠어.”",
            "천막에서 쉬어가면 지난 기록들이 저장됩니다."});
        talkData.Add(201, new string[] { "“역시 잠시라도 쉬길 잘했군. 몸이 가벼워졌어.”",
            "피로도가 일정 수치 회복됐습니다."});
        ...
        talkData.Add(205, new string[] { "“이 나무라면 충분히 벨 수 있겠는데?”",
    ...
    private void SecondChapterDialog()
    {
        ...
        talkData.Add(301, new string[] { "“드디어 숲 입구까지 들어 온 건가? 어두워지기 전에 서둘러야겠어.”",
            "“그런데 이곳은...”",
            "“전부 나무로 둘러싸여 있잖아?”",
            "“무슨 미로 같군. 여길 지나가려면 정신을 바짝 차려야겠어. ”"});

        talkData.Add(302, new string[] { "“여기 웬 도끼가 떨어져 있잖아? 이거 잘하면 요긴하게 쓰이겠는 걸?”",
            "SPACE BAR를 통해 도끼를 사용할 수 있습니다. "});
    ...
    {
        talkData.Add(400, new string[] { "“어? 여기 또 천막이 있잖아?”" ,
            "“이런 것 보면 사람의 왕래가 아예 없던 무인도는 아닌 것 같은데...”",
            "“우선 쉬었다 갈까?”"});

        talkData.Add(401, new string[] { "피로도가 일정 수치 회복됐습니다." });

        talkData.Add(402, new string[] { "“뭐지? 아깐 천막에 정신 팔려서 못 봤는데 숲 한가운데 동굴이 있잖아?”",
            "“딱 봐도 위험해 보이는데.”",
            "“...”",
    ...
    private void FifthChapterDialog()
    {
        talkData.Add(900, new string[] { "“...!”" ,
            ...
            "“이러고 있을 시간이 없어.”",
            "“어서 움직이자.” "});
        talkData.Add(901, new string[] { "신호탄을 획득하였습니다. " ,
            "“이것만 있다면 구조 신호를 보낼 수 있을거야.”"});
        talkData.Add(902, new string[] { "스위치를 키자 다음 공간으로 지나갈 수 있는 다리가 열렸다. " });
        talkData.Add(903, new string[] { "앞에 보이는 소라고동을 밟으면 랜덤한 위치의 소라고동으로 이동됩니다.",
            "단, 한 번 이동된 곳으로는 다시 이동되지 않습니다.",
            "소라고동을 활용하여 막다른 길의 미로를 탈출해보세요."});
    }
}
