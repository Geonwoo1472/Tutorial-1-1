...
public class TalkManager : MonoBehaviour
{
    ...
    private void FirstChapterDialog()
    {
        talkData.Add(100, new string[] { "p:이런곳에 표지판이 있다니, 일단 확인해보자.",
            "j:Space bar를 누르면 물체와 상호작용 할 수 있습니다." });

        talkData.Add(101, new string[] { "j:앞을 가로막고 있는 상자를 움직여 길을 지나갈 수 있습니다." ,
            "p:상자를 움직여서 길을 뚫고 앞으로 나아가라는 건가?",
            "p:설마 함정은 아니겠지...",
            "p:다른 방법도 없으니 일단 표지판에 쓰여진 대로 해볼까?",
            "j:상자를 이동하면 피로도가 감소합니다.",
            "j:피로도를 전부 소모하면 게임이 종료됩니다."});

        talkData.Add(102, new string[] { "j: 맵을 이동할 때 마다 배고픔이 감소합니다.",
            "j:주어진 배고픔을 전부 소모하면 게임이 종료됩니다.",
            "p:저기 있는 건 뭐지? 뭔가 먹을 수 있는 거라면 좋겠는데.."});

        talkData.Add(103, new string[] { "j: 음식을 획득하였습니다." ,
            "j: 음식을 먹으면 배고픔을 회복할 수 있습니다." ,
            "j: I키를 눌러 인벤토리를 열고 아이템을 사용해보세요.",
            "j: 자주 사용하는 아이템은 퀵 슬롯에 등록하여 간편하게 사용할 수 있습니다."});
