...
public class IntroTalkManager : MonoBehaviour
{
    ...
    private void IntroDialog()
    {
        talkData.Add(0, new string[] { "멀지 않은 곳에서 파도 소리가 들려온다.:0",
            ...
            "기침과 함께 토해냈지만 여전히 혓바닥과 입 천장은 까끌거린다.:1",
            "뻑뻑한 눈을 손으로 비벼 억지로 뜨니 그제야 주변 풍경이 눈에 들어온다.:1",
            "쨍쨍히 내리쬐며 시야를 방해하는 햇살, 모래사장과 사방이 바다로 둘러싸인, 이곳은 사람 한 명 살 것 같지 않은 무인도다.:1",
            "‘분명 마지막엔…’ :1",
            "존은 기억을 떠올렸다.:1",
            "폭풍우와 부서진 배, 그리고 항해를 함께 했던 선원들의 모습이 조각조각 떠오른다.:1",
            "“이봐! 아무도 없어?!”:1",
